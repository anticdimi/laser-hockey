...
# Training params
parser.add_argument('--max_episodes', help='Max episodes for training', type=int, default=35000)
...
parser.add_argument('--lr_factor', help='Scale learning rate by', type=float, default=1)#0.5
parser.add_argument('--lr_milestones', help='Learning rate milestones', nargs='+', default=[19000])
...
parser.add_argument('--update_target_every', help='# of steps between updating target net', type=int, default=2)#1
...
parser.add_argument('--TD3agent', help='Which agent to use', action='store_true', default=True)
