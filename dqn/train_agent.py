...
# Training params
parser.add_argument('--max_episodes', help='Max episodes for training', type=int, default=3000)
...
parser.add_argument('--per', help='Utilized Prioritized Experience Replay', action='store_true')
