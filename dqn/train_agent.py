...
# Training params
parser.add_argument('--max_episodes', help='Max episodes for training', type=int, default=600)
...
parser.add_argument('--epsilon_decay', help='Epsilon decay', type=float, default=0.989)
